...
if(isset($_POST['Student_Id'])){
    ...
    $sql2="select * from Book_Details , Borrower_Details where ((Borrower_Id='$Student_Id') AND (Book_Details.ISBN_Code = Borrower_Details.ISBN_Code ) )";
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
    ...
    <div class="w3-container" id="Starting" style="margin-top:80px">
        <h1 class="w3-jumbo"><b>Books Issued</b></h1>
    </div>

    <div class="w3-container" id="Forum" style="margin-top:75px">


        <form action="Student_Issue.php" METHOD="post">
